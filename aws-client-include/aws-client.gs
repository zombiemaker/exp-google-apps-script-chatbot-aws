/*
  ...
  This version of the script is for use cases where you want to include the script in the same Google Apps Script Project that your main project script is located.
